						...
						<div className="legal-card">
							...
							<section>
								...
								<p>
									...
									the same keyed, pseudonymous IP hashing approach for short-lived abuse prevention.
								</p>
							</section>
							<section>
								<h2>Analytics</h2>
							...
							<section>
								...
								<ul>
									...
									<li>Diagnose technical failures based on legitimate interests in operating a reliable and secure service.</li>
