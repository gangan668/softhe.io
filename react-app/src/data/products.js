export const PRODUCTS = [
	{
		...
		features: ['Zero bloatware', 'Gaming optimizations', 'Minimal background tasks', 'Updates until EOL 2027'],
		icon: 'fab fa-windows',
		badge: 'Best Seller',
	},
	{
		...
		features: ['DirectX 12 Ultimate', 'Auto HDR support', 'Optimizations for windowed fullscreen', 'Regular updates'],
		icon: 'fab fa-windows',
		badge: null,
	},
	{
