...
if (process.env.VITE_REQUIRE_PRODUCTION_CONFIG === 'true' || process.env.VERCEL === '1') {
	...
	if (process.env.VITE_PORTAL_ENABLED === 'true') add('VITE_SUPABASE_URL','VITE_SUPABASE_PUBLISHABLE_KEY','SUPABASE_URL','SUPABASE_PUBLISHABLE_KEY','SUPABASE_SERVICE_ROLE_KEY','UPSTASH_REDIS_REST_URL','UPSTASH_REDIS_REST_TOKEN','PORTAL_RATE_LIMIT_SECRET');
